        ...
        public ProductViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //Toast.makeText(mCtx,productList.get(position).getTitle(),Toast.LENGTH_LONG).show();
                    Intent intent=new Intent(mCtx,ShowActivity.class);
                    intent.putExtra("image",productList.get(position).getImage());
                    intent.putExtra("name",productList.get(position).getTitle());
                    intent.putExtra("short",productList.get(position).getShortdesc());
